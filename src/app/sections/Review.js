        ...
        <section className='review-section'>
            ...
            <div className='review-cards'>
                ...
                <div className='review-card'>
                    <div className='review-head'>
                        <div className='review-user-info'>
                            <Image src='/images/Ellipse 29.png' className='ellipse-img' />
                            <div className='user-name'>
                                <h5>Arlene McCoy</h5>
                                <p>One year of using Billia</p>
                            </div>
                        </div>
                        <span className='quote'><Image src='/images/quote.png' className='quote'/></span>
                    </div>
                    ...
                    <div className='review'>
                        <p>4 June 2025</p>
                        <span className='review-rating'><Image src='/images/star-icon.png' /> 4.7/5.0</span>
                    </div>
                </div>
                ...
                <div className='review-card'>
                    <div className='review-head'>
                        <div className='review-user-info'>
                            <Image src='/images/Ellipse 29 (1).png' className='ellipse-img' />
                            <div className='user-name'>
                    ...
                    <div className='review'>
                        <p>24 April 2025</p>
                        <span className='review-rating'><Image src='/images/star-icon.png' /> 4.5/5.0</span>
                    </div>
                </div>
                <div className="circle">
