      ...
      <div className="about-main-details">
        ...
        <div className="about-main-2">
          ...
          <div className="about-main-text">
            ...
            <p>
              <span className="miss">Mission:</span> To make bill payments effortless, intelligent, and
              {/* <br/>  */}
            ...
            <p>
              <span className="miss">Vision: </span>A future where anyone can manage their financial life from
              {/* <br/> */}
