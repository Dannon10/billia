...
export default function Article() {
  return (
    <section className='article-section'>
        <Image src='/images/imaImage7.png' className='article-img'/>
        <div className='article-text'>
            ...
            <h5><span><Image src='/images/Group.png' className='article-icons'/></span> Pay Bills by typing a command</h5>
            ...
            <div className='article-points'>
            <h5><span><Image src='/images/Vector (2).png' className='article-icons'/></span>In-App Chat Assistance</h5>
