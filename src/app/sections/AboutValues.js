    ...
    <section className='about-values-section'>
        ...
        <div className='value-cards'>
            ...
            <div className='value-card light-yellow'>
                ...
                <img src='/images/compass.png' className="about-value-img" />
                </div>
            </div>
            ...
            <div className='value-card light-green'>
                ...
                <p>Your data and money are protected by real- 
                 ...
                 time security 
                    and compliance.</p>
                    <div className="value-image">
                <img src='/images/lock.png'  className="about-value-img"/>
                    </div>
            </div>
            ...
            <div className='value-card light-pink'>
                ...
                <div className="value-image">
                <img src='/images/brain.png'  className="about-value-img"/>
                </div>
            </div>
